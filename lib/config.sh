...
devvm_load_config() {
	...
	DEVVM_CODE_DIR="${DEVVM_CODE_DIR:-/code}"
	...
	export DEFAULT_NODE_VERSION DEFAULT_PORTS DEFAULT_MOUNTS GLOBAL_MOUNTS
	...
	export AI_VM_CODE_DIR AI_LLAMA_CPP_REPO AI_LLAMA_CPP_REF AI_LLAMA_MODELS
